    ...
    function($scope, $rootScope, $http, $location, Global) {
      ...
      $scope.register = function() {
        ...
        $http.post('/register', {
          ...
          // commented to prevent auto logging after registration
            // authentication OK
            ...
            //$location.url('/');
              ...
              $scope.activationMsg = 'Your account has been successfully created. An email has been sent email address you provided, Please activate your account with the link provided in your email';
